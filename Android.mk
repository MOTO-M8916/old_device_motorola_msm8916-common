...
FIRMWARE_WCNSS_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(FIRMWARE_WCNSS_IMAGES)))
...
FIRMWARE_WIDEVINE_SYMLINKS := $(addprefix $(TARGET_COPY_OUT_VENDOR)/etc/firmware/,$(notdir $(FIRMWARE_WIDEVINE_IMAGES)))
